...
import Record from './fastParity_Record.jsx';
import axios from 'axios';
import { useHistory } from "react-router-dom";
import * as api from "../../api/auth.js";


const FastParityFullRecord = () => {
  const URL =  api.url;
  ...
  useEffect(() => {
    ...
    useEffect(() => {
      axios.get(`${URL}/fastParity_getFullRecord/`)
      .then(response => {
        ...
        <div>
            <Grid container direction="row" justify="" alignItems="center" style={{paddingLeft: '20px',paddingTop: '15px',paddingBottom: '15px',paddingRight: '20px', backgroundColor: 'white'}}>
                ...
                <ArrowBackIosIcon style={{fontSize:'20px'}} onClick={history.goBack} />
                 ...
                 <Grid item xs={4}>                    
                <Typography align="center" >{'Fast Parity'} Record History</Typography>
                 </Grid>
            </Grid>
...
export default FastParityFullRecord ; 
