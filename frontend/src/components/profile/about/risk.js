        ...
        <div>
            <Grid container direction="row" justify="" alignItems="center"style={{paddingLeft: '20px',paddingRight: '20px'}}>
                ...
                <ArrowBackIosIcon style={{fontSize:'20px'}} />
                 ...
                 <Grid item xs={4}>                    
                <Typography align="center" st>Risk Disclosure Agreement</Typography>
                 </Grid>
            </Grid>
            <Typography align="center"  display="block" style={{fontSize:'10px'}}>Chapter 1.Booking/Collection Description
...
5. For further details, please refer to the Business Guidelines in the front page of the mall, Understanding Frany Shop.


Chapter 2 Reveals the business model of Frany-Shop
...
1.Minors under the age of 18 are not permitted to participate in The Frany-Shop Advance Booking/Recycling.
2.Frany-Shop Advance Booking/Repo is only available to customers who meet all of the following criteria:
...
②　To fully understand all risks associated with Frany Shop Advance Booking/Repurchase business and have a certain risk tolerance.

③　Have a certain understanding of gold and silver and its products:

A. Policy-related risk disclosure, such as changes in national laws, regulations and policies, contingency measures, implementation of appropriate regulatory measures, Frany-Shop regulatory system and changes in management methods and regulations, etc., all risks that may affect customer bookings/repurchases, etc., the customer must bear the losses incurred.
...
A. The price quoted by the Frany-Shop Prepayment Booking/Repo System is based on the systems real-time trading price and may differ slightly from the commodity prices in other markets.
Frany-Shop cannot guarantee that the above prepayment booking//repurchase price is fully consistent with other markets.
B. At Frany-Shop;, once the customers pre-payment booking/repurchase application submitted through the online terminal is completed, it cannot be withdrawn and the customer must accept the risks associated with such a subscription.
C. Frany-Shop prohibits regional service providers and their staff from providing any profit guarantee to customers, from engaging in prepaid bookings/repurchases on behalf of customers, or from sharing profits or risks with customers. Customer should be aware that any profit guarantee or commitment that Frany-Shop advance booking/repurchase does not have a loss, profit share or risk-sharing is impossible, unfounded, and incorrect.
D. The customers pre-paid booking / repurchase application must be based on the customers own decision. Frany-Shop and regional service providers and employees do not provide booking / buyback to the client, nor does it constitute any commitment if the client makes a booking / buyback decision accordingly.
...
If in case the amount is deducted from your account and the transaction has failed, the same will be refunded back to your account within 72 hours.</Typography>
