exports = async function () {
    ...
    const currentBidCollection = mongodb.db("toddapple").collection("test_newPeriod");
    const bidCollection = mongodb.db("toddapple").collection("test_history");
    const periodCollection = mongodb
      .db("toddapple")
      .collection("test_newPeriodResult");
    const usersCollection = mongodb.db("toddapple").collection("newUsers");
    const priceCollection = mongodb.db("toddapple").collection("test_newPrice");
    const playHistoryCollection = mongodb
      .db("toddapple")
      .collection("test_playhistories");
    const extraCollection = mongodb.db("toddapple").collection("test_extras");
