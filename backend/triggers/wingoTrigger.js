exports = async function () {
  ...
  const currentBidCollection = mongodb.db("vga2").collection("newPeriod");
  const bidCollection = mongodb.db("vga2").collection("history");
  const periodCollection = mongodb
    .db("vga2")
    .collection("newPeriodResult");
  const usersCollection = mongodb.db("vga2").collection("newUsers");
  const priceCollection = mongodb.db("vga2").collection("newPrice");
  const playHistoryCollection = mongodb
    .db("vga2")
    .collection("playhistories");
  const extraCollection = mongodb.db("vga2").collection("extras");
  ...
  if (isAuto.wingo.auto) {
    ...
    var red0 = getRed["0price"] * 2;
    var green0 = getGreen["0price"] * 2;
    var gviolet0 = getViolet["0price"] * 4.5 + getGreen["0price"] * 1.5;
    var rviolet0 = getViolet["0price"] * 4.5 + getRed["0price"] * 1.5;

    if (red0 <= green0 && red0 <= gviolet0 && red0 <= rviolet0) {
      if (red0 === 0) {
        price0 = 20000 + Math.floor(Math.random() * 900) + 100;
        number0 = price0 % 10;
      } else {
        ...
        number0 = arr[0];
        price0 = parseInt(
          "20" + `${Math.floor(Math.random() * 90) + 10}` + `${number0}`
        );
      }
    } else if (green0 <= red0 && green0 <= rviolet0 && green0 <= gviolet0) {
      var arr = [1, 3, 7, 9];
      shuffleArray(arr);
      number0 = arr[0];
      price0 = parseInt(
    ...
    } else if (rviolet0 <= red0 && rviolet0 <= green0 && rviolet0 <= gviolet0) {
      number0 = 0;
      price0 = parseInt(
        "20" + `${Math.floor(Math.random() * 90) + 10}` + `${number0}`
      );
    ...
    //game 1
    var red1 = getRed["1price"] * 2;
    var green1 = getGreen["1price"] * 2;
    var gviolet1 = getViolet["1price"] * 4.5 + getGreen["1price"] * 1.5;
    var rviolet1 = getViolet["1price"] * 4.5 + getRed["1price"] * 1.5;

    if (red1 <= green1 && red1 <= gviolet1 && red1 <= rviolet1) {
      if (red1 === 0) {
        price1 = 20000 + Math.floor(Math.random() * 900) + 100;
        number1 = price1 % 10;
      } else {
        ...
        number1 = arr[0];
        price1 = parseInt(
          "20" + `${Math.floor(Math.random() * 90) + 10}` + `${number1}`
        );
      }
    } else if (green1 <= red1 && green1 <= rviolet1 && green1 <= gviolet1) {
      var arr = [1, 3, 7, 9];
      shuffleArray(arr);
      number1 = arr[0];
      price1 = parseInt(
    ...
    } else if (rviolet1 <= red1 && rviolet1 <= green1 && rviolet1 <= gviolet1) {
      number1 = 0;
      price1 = parseInt(
        "20" + `${Math.floor(Math.random() * 90) + 10}` + `${number1}`
      );
    ...
    //game 2
    var red2 = getRed["2price"] * 2;
    var green2 = getGreen["2price"] * 2;
    var gviolet2 = getViolet["2price"] * 4.5 + getGreen["2price"] * 1.5;
    var rviolet2 = getViolet["2price"] * 4.5 + getRed["2price"] * 1.5;

    if (red2 <= green2 && red2 <= gviolet2 && red2 <= rviolet2) {
      if (red2 === 0) {
        price2 = 20000 + Math.floor(Math.random() * 900) + 100;
        number2 = price2 % 10;
      } else {
        ...
        number2 = arr[0];
        price2 = parseInt(
          "20" + `${Math.floor(Math.random() * 90) + 10}` + `${number2}`
        );
      }
    } else if (green2 <= red2 && green2 <= rviolet2 && green2 <= gviolet2) {
      var arr = [1, 3, 7, 9];
      shuffleArray(arr);
      number2 = arr[0];
      price2 = parseInt(
    ...
    } else if (rviolet2 <= red2 && rviolet2 <= green2 && rviolet2 <= gviolet2) {
      number2 = 0;
      price2 = parseInt(
        "20" + `${Math.floor(Math.random() * 90) + 10}` + `${number2}`
      );
    ...
    var red3 = getRed["3price"] * 2;
    var green3 = getGreen["3price"] * 2;
    var gviolet3 = getViolet["3price"] * 4.5 + getGreen["3price"] * 1.5;
    var rviolet3 = getViolet["3price"] * 4.5 + getRed["3price"] * 1.5;

    if (red3 <= green3 && red3 <= gviolet3 && red3 <= rviolet3) {
      if (red3 === 0) {
        price3 = 20000 + Math.floor(Math.random() * 900) + 100;
        number3 = price3 % 10;
      } else {
        ...
        number3 = arr[0];
        price3 = parseInt(
          "20" + `${Math.floor(Math.random() * 90) + 10}` + `${number3}`
        );
      }
    } else if (green3 <= red3 && green3 <= rviolet3 && green3 <= gviolet3) {
      var arr = [1, 3, 7, 9];
      shuffleArray(arr);
      number3 = arr[0];
      price3 = parseInt(
    ...
    } else if (rviolet3 <= red3 && rviolet3 <= green3 && rviolet3 <= gviolet3) {
      number3 = 0;
      price3 = parseInt(
        "20" + `${Math.floor(Math.random() * 90) + 10}` + `${number3}`
      );
  ...
  winnersNumber.forEach((doc) => {
    ...
    userWalletList.push({
      updateOne: {
        filter: { id: doc.userId },
        update: { $inc: { balance: +fixedAmount } },
      },
    });
  });
  ...
  await usersCollection.bulkWrite(userWalletList,{ ordered : false });
  }
