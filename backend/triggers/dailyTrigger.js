exports = function(changeEvent) {
    ...
    const dailyCollection = mongodb.db("toddapple").collection("daily");

  
  if(changeEvent.fullDocument.status === 'success'){
   const date = new Date();
  ...
  const year = newDatefor.getFullYear();
    ...
    dailyCollection.updateOne({id: newDate}, {$inc: {'amount': changeEvent.fullDocument.amount, 'count': +1}}, {upsert: true});
