...
const tabs = [
  ...
  { id: 'usdt', label: 'USDT Deposits', routeName: 'MasterAdminUsdtDeposits', icon: '<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"18\" height=\"18\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\"><circle cx=\"12\" cy=\"12\" r=\"10\"/><path d=\"M12 6v12M8 10h8M8 14h8\"/></svg>' },
...
.content-header h1 { font-size: 1.6rem; font-weight: 800; color: #1e293b; margin: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }

.tab-view { padding: 40px; max-width: 1400px; margin: 0 auto; width: 100%; box-sizing: border-box; }
