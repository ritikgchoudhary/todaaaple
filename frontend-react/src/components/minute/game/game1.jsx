...
const NewGamePage = () => {
  ...
  return (
    <Box className={classes.wingoRoot}>
    <Container disableGutters maxWidth={false} style={{ maxWidth: "100%", padding: 0 }}>
      <Dialog
...
If the result shows 5, you will get (98*1.5) 147rupees.</Typography>
      ...
      >
        <Grid item xs style={{ minWidth: 0 }}>
          <div style={{ overflow: "hidden" }}>
            <Typography align="left" style={{ color: "white", fontSize: "13px" }}>Available Balance</Typography>
            <Typography align="left" variant="h6" style={{ color: "white", marginTop: "-5px", fontSize: "1rem" }}>
              ₹ {user && user[0] && user[0].balance != null ? user[0].balance.toFixed(2) : "0.00"}
            </Typography>
            <Typography style={{ color: "white", marginTop: "10px", fontSize: "12px" }}>
              No. {user && user[0] && user[0].id}
            </Typography>
          </div>
        </Grid>
        <Grid item style={{ flexShrink: 0, display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 8 }}>
          <Typography component="span" style={{ cursor: "pointer", lineHeight: 1 }} onClick={openRule}>
            <img src={Rule} height={17} alt="rule" />
          </Typography>
          <a href={user && user[0] ? `/placeOrder3/${user[0].id}/${user[0].token}` : "/recharge"} style={{ lineHeight: 0 }}>
            <img src={Recharge} height={22} alt="recharge" />
          </a>
        </Grid>
      </Grid>
      <Box className={classes.wingoSection} sx={{ width: "100%", paddingBottom: 12 }}>
        <Grid container spacing={1} direction="row" alignItems="stretch">
          <Grid item xs={4}>
            <Link to="/wingo/1" style={{ textDecoration: "none", display: "block", height: "100%" }}>
              <Button
                fullWidth
                style={{
                  backgroundColor: params.id === "1" ? "#00b8a9" : "white",
                  color: params.id === "1" ? "white" : "black",
              ...
              >
                <span>1 Min</span>
                <img src={Timer} height={14} width={14} style={{ objectFit: "contain" }} alt="" />
              </Button>
            </Link>
          </Grid>
          <Grid item xs={4}>
            <Link to="/wingo/3" style={{ textDecoration: "none", display: "block", height: "100%" }}>
              <Button
                fullWidth
                style={{
                  backgroundColor: params.id === "3" ? "#00b8a9" : "white",
                  color: params.id === "3" ? "white" : "black",
                  borderRadius: 17,
                  textTransform: "none",
                  fontSize: "14px",
                  height: 52,
          ...
          <Grid item xs={4}>
            <Link to="/wingo/5" style={{ textDecoration: "none", display: "block", height: "100%" }}>
              <Button
                fullWidth
                style={{
                  backgroundColor: params.id === "5" ? "#00b8a9" : "white",
                  color: params.id === "5" ? "white" : "black",
      ...
      <Grid
        ...
        spacing={2}
        direction="row"
        className={classes.wingoSection}
      >
        <Grid item xs={4}>
          <Button
            style={{
      ...
      >
        <Grid
          ...
          className={classes.numberCircle}
          style={{
            borderRadius: "50%",
            padding: 0,
        ...
        >
          <Typography style={{ color: "white", fontSize: "16px" }}>0</Typography>
        </Grid>
        <Grid
          item
          container
        ...
        >
          <Typography style={{ color: "white", fontSize: "16px" }}>4</Typography>
        </Grid>
      </Grid>
      <Grid
        container
      ...
      >
        ...
        >
          <Typography style={{ color: "white", fontSize: "16px" }}>5</Typography>
        </Grid>
        <Grid
          item
          container
        ...
        >
          <Typography style={{ color: "white", fontSize: "16px" }}>6</Typography>
        </Grid>
        <Grid
          item
          container
        ...
        >
          <Typography style={{ color: "white", fontSize: "16px" }}>7</Typography>
        </Grid>
        <Grid
          item
          container
        ...
        >
          <Typography style={{ color: "white", fontSize: "16px" }}>8</Typography>
        </Grid>
        <Grid
          item
          container
        ...
        >
          <Typography style={{ color: "white", fontSize: "16px" }}>9</Typography>
        </Grid>
      </Grid>
      <Grid
        container
      ...
      <Container className={classes.bottomSpacer} style={{ paddingTop: "20px" }}>
        <Grid container direction="row" justify="space-between">
          <Grid item>
            <Typography>{params.id} Bid History</Typography>
          </Grid>
          <Link to={`/minutes/bidHistory/${params.id}`} style={{textDecoration: 'none', color: 'black'}}>
          <Grid item>
            <Typography style={{ color: "grey" }}>more ›</Typography>
          </Grid>
          </Link>
